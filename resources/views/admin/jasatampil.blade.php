        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/jasa/hapus/{{$j->id}}" class="btn btn-danger btn-sm" onclick="javascript:return confirm('apakah yakin akan menghapus data ?')"><i class="fas fa-trash-alt" onclick="javascript:return confirm('apakah yakin akan menghapus data ?')"></i> Hapus</a>
                </td>
            </tr>
            @endforeach
        </tbody>
